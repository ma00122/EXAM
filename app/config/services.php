...
// MySQL Example (utilise TCP via 127.0.0.1 pour LAMPP):
$dsn = 'mysql:host=' . $config['database']['host'] . ';port=' . ($config['database']['port'] ?? '3306') . ';dbname=' . $config['database']['dbname'] . ';charset=utf8mb4';
