...
(2, 'Toamasina', 'Atsinanana'),
(3, 'Mahajanga', 'Boeny'),
(4, 'Fianarantsoa', 'Haute Matsiatra'),
(5, 'Toliara', 'Atsimo-Andrefana');
...
INSERT INTO besoin (id, ville_id, type_id, produit, quantite, quantite_initiale, quantite_satisfaite, prix_unitaire, date_saisie) VALUES
-- RIZ (Total besoin: 140, Don: 100)
(1, 1, 1, 'Riz', 30, 30, 0, 2500.00, '2026-02-01'),  -- Tana: 30
(2, 2, 1, 'Riz', 50, 50, 0, 2500.00, '2026-02-02'),  -- Toamasina: 50
(3, 3, 1, 'Riz', 40, 40, 0, 2500.00, '2026-02-03'),  -- Mahajanga: 40
(4, 4, 1, 'Riz', 20, 20, 0, 2500.00, '2026-02-04'),  -- Fianarantsoa: 20

-- HUILE (Total besoin: 90, Don: 60)
(5, 1, 1, 'Huile', 20, 20, 0, 4500.00, '2026-02-01'),  -- Tana: 20
(6, 2, 1, 'Huile', 30, 30, 0, 4500.00, '2026-02-02'),  -- Toamasina: 30
(7, 3, 1, 'Huile', 25, 25, 0, 4500.00, '2026-02-03'),  -- Mahajanga: 25
(8, 4, 1, 'Huile', 15, 15, 0, 4500.00, '2026-02-04'),  -- Fianarantsoa: 15

-- TÔLE (Total besoin: 70, Don: 50)
(9, 1, 2, 'Tôle', 10, 10, 0, 10000.00, '2026-02-01'),   -- Tana: 10
(10, 2, 2, 'Tôle', 15, 15, 0, 10000.00, '2026-02-02'),  -- Toamasina: 15
(11, 3, 2, 'Tôle', 20, 20, 0, 10000.00, '2026-02-03'),  -- Mahajanga: 20
(12, 4, 2, 'Tôle', 25, 25, 0, 10000.00, '2026-02-04'),  -- Fianarantsoa: 25

-- CIMENT (Total besoin: 40, Don: 40 - exactement égal)
(13, 1, 2, 'Ciment', 10, 10, 0, 25000.00, '2026-02-01'),  -- Tana: 10
(14, 2, 2, 'Ciment', 10, 10, 0, 25000.00, '2026-02-02'),  -- Toamasina: 10
(15, 3, 2, 'Ciment', 10, 10, 0, 25000.00, '2026-02-03'),  -- Mahajanga: 10
(16, 4, 2, 'Ciment', 10, 10, 0, 25000.00, '2026-02-04');  -- Fianarantsoa: 10

-- ============================================================
-- DONS EN NATURE - Pour tests de simulation
-- ============================================================
INSERT INTO don (id, type_produit, quantite, quantite_initiale, date_saisie) VALUES
-- RIZ: 100 unités (besoins = 140, manque 40)
(1, 'Riz', 100, 100, '2026-02-05'),

-- HUILE: 60 unités (besoins = 90, manque 30)
(2, 'Huile', 60, 60, '2026-02-06'),

-- TÔLE: 50 unités (besoins = 70, manque 20)
(3, 'Tôle', 50, 50, '2026-02-07'),

-- CIMENT: 40 unités (besoins = 40, parfait)
(4, 'Ciment', 40, 40, '2026-02-08');

-- ============================================================
-- DONS EN ARGENT - Pour achats des besoins restants
-- ============================================================
INSERT INTO don_argent (id, montant, montant_initial, donateur, date_saisie, montant_utilise, statut, notes) VALUES
(1, 500000.00, 500000.00, 'Association Solidarité', '2026-02-01', 0, 'disponible', 'Don général'),
(2, 300000.00, 300000.00, 'Entreprise TELMA', '2026-02-02', 0, 'disponible', 'RSE'),
(3, 200000.00, 200000.00, 'Anonyme', '2026-02-03', 0, 'disponible', NULL);

-- ============================================================
-- VÉRIFICATION MANUELLE DES 3 MODES DE SIMULATION
-- ============================================================
